...
public class GameManager {
	...
	static Pion pionSelectionneReserve; //reset à null après le placement de chaque pion
	 ...
	 * @throws InterruptedException
	 */
	private static void connexionClient(String courrier) throws ClassNotFoundException, IOException, InterruptedException {
	...
	public static void recupJoueur() {
		elements = MultiServer.reception.split(" ");
